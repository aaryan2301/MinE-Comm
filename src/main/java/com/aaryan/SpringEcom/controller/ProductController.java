package com.aaryan.SpringEcom.controller;
...
import com.aaryan.SpringEcom.model.Product;
import com.aaryan.SpringEcom.service.ProductService;
...
public class ProductController {
    ...
    @PostMapping("/product")
    public ResponseEntity<?> addProduct(@RequestPart Product product, @RequestPart(value = "imageFile", required = false) MultipartFile imageFile){
    ...
    public ResponseEntity<String> updateProduct(@PathVariable int id, @RequestPart Product product, @RequestPart(value = "imageFile", required = false) @Nullable MultipartFile imageFile){
